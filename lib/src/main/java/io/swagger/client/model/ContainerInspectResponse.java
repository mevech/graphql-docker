...
import io.swagger.client.model.ContainerState;
...
public class ContainerInspectResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, created, path, args, state, image, resolvConfPath, hostnamePath, hostsPath, logPath, node, name, restartCount, driver, platform, mountLabel, processLabel, appArmorProfile, execIDs, hostConfig, graphDriver, sizeRw, sizeRootFs, mounts, config, networkSettings);
  }
